...
-- Started on 2024-06-08 10:38:39
...
--
-- TOC entry 245 (class 1255 OID 57648)
...
--
-- TOC entry 233 (class 1255 OID 49415)
...
--
-- TOC entry 232 (class 1259 OID 57649)
-- Name: vue_details_cours_url; Type: VIEW; Schema: public; Owner: anonyme
--

CREATE VIEW public.vue_details_cours_url AS
 SELECT dc.cours_id,
    dc.titre,
    dc.description,
    dc.enseignant_id,
    ...
    cr.type,
    cr.url
   FROM (public.vue_details_cours dc
     JOIN public.vue_cours_ressources cr ON ((dc.cours_id = cr.cours_id)));


ALTER VIEW public.vue_details_cours_url OWNER TO anonyme;
...
--
-- TOC entry 4744 (class 2604 OID 49431)
...
--
-- TOC entry 4922 (class 0 OID 49328)
-- Dependencies: 218
...
64	undefined	Step 1	2
65	undefined	Pikachu	2
66	undefined	Pikachu	2
67	undefined	Commerce en ligne	2
68	undefined	Commerce en ligne	2
69	undefined	Commerce en ligne	2
70	undefined	Commerce en ligne	2
\.


--
-- TOC entry 4926 (class 0 OID 49367)
-- Dependencies: 222
...
--
-- TOC entry 4924 (class 0 OID 49355)
-- Dependencies: 220
...
--
-- TOC entry 4930 (class 0 OID 49428)
-- Dependencies: 226
...
--
-- TOC entry 4928 (class 0 OID 49381)
-- Dependencies: 224
...
--
-- TOC entry 4920 (class 0 OID 49314)
-- Dependencies: 216
...
SELECT pg_catalog.setval('public.cours_cours_id_seq', 83, true);
...
SELECT pg_catalog.setval('public.ressources_ressource_id_seq', 73, true);
...
--
-- TOC entry 4755 (class 2606 OID 49335)
...
--
-- TOC entry 4759 (class 2606 OID 49374)
...
--
-- TOC entry 4757 (class 2606 OID 49360)
...
--
-- TOC entry 4763 (class 2606 OID 49436)
...
--
-- TOC entry 4761 (class 2606 OID 49386)
...
--
-- TOC entry 4749 (class 2606 OID 49326)
...
--
-- TOC entry 4751 (class 2606 OID 49324)
...
--
-- TOC entry 4753 (class 2606 OID 49322)
...
--
-- TOC entry 4764 (class 2606 OID 49336)
...
--
-- TOC entry 4766 (class 2606 OID 49375)
...
--
-- TOC entry 4765 (class 2606 OID 49361)
-- Name: quiz quiz_cours_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: anonyme
--
...
--
-- TOC entry 4769 (class 2606 OID 49437)
...
--
-- TOC entry 4767 (class 2606 OID 49387)
...
--
-- TOC entry 4768 (class 2606 OID 49392)
...
-- Completed on 2024-06-08 10:38:39
